...
void RobotMotion::updateGlobalRobotPos(){
	if(currentState == standing){
		g_localRobotPos.x += (double)joy_axis[3]/32767.0*2.5/updateRate;
		g_localRobotPos.y += (double)joy_axis[4]/32767.0*1.5/updateRate;
		...
		g_localRobotPos.pitch = 20.0*(double)joy_axis[1]/32767.0*pivotSpeed/updateRate;
	}
}
